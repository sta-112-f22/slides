---
title: "Welcome to Introduction to Reegression and Data Science"
...
# $\tiny\color{green}{logit(y)} = \beta_0 + \beta_1X_1 + \beta_2X_2+...$
...
- Once you log on to RStudio Pro, create a new project. Then File > New File > Quarto Document
- Go to [`bit.ly/sta-112-f22-appex-01`](https://bit.ly/sta-112-f22-appex-01). Copy the starter code and paste in  your new file
